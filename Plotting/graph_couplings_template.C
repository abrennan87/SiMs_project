...
void graph_couplings() {
   ...
   TGraph2D *gr1 = new TGraph2D("text_graphs/couplinglimits_MODEL_min_ratRAT.txt");
   ...
   if (s0.compare(s1)==0) line.DrawLatex(0.6, 0.34, "g_{DM}/g_{q} = 1/5");
   if (s0.compare(s2)==0) line.DrawLatex(0.6, 0.34, "g_{DM}/g_{q} = 1/2");
   if (s0.compare(s3)==0) line.DrawLatex(0.6, 0.34, "g_{DM}/g_{q} = 1");
   if (s0.compare(s4)==0) line.DrawLatex(0.6, 0.34, "g_{DM}/g_{q} = 2");
   if (s0.compare(s5)==0) line.DrawLatex(0.6, 0.34, "g_{DM}/g_{q} = 5");
   ...
   c1->Modified();
   c1->SaveAs("coupling_limits_MODEL_min_ratRAT.pdf");
}
