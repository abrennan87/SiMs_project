...
C     
C     Process: u u~ > z chi chi~ WEIGHTED=4
...
C     ----------
      ...
      CALL FFV2_4_3(W(1,3),W(1,4),GC_41,GC_48,MDL_MZ,MDL_WZ,W(1,5))
      CALL OXXXXX(P(0,5),MDL_MCHI,NHEL(5),+1*IC(5),W(1,4))
      CALL IXXXXX(P(0,6),MDL_MCHI,NHEL(6),-1*IC(6),W(1,3))
      CALL FFV2_5_2(W(1,1),W(1,5),GC_42,GC_47,MDL_MU,ZERO,W(1,6))
      CALL FFS2_3(W(1,3),W(1,2),GC_21,MDL_METAU,MDL_WETAU,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFS1_0(W(1,6),W(1,4),W(1,7),GC_21,AMP(1))
      CALL FFS1_3(W(1,1),W(1,4),GC_21,MDL_METAU,MDL_WETAU,W(1,6))
      CALL FFV2_5_1(W(1,2),W(1,5),GC_42,GC_47,MDL_MU,ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL FFS2_0(W(1,3),W(1,4),W(1,6),GC_21,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL VSS1_0(W(1,5),W(1,6),W(1,7),GC_49,AMP(3))
