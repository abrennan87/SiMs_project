...
C     
C     Process: s s~ > z chi chi~ WEIGHTED=4
...
C     ----------
      ...
      CALL FFV2_3_2(W(1,1),W(1,5),GC_41,GC_47,MDL_MS,ZERO,W(1,6))
      CALL FFS2_3(W(1,3),W(1,2),GC_13,MDL_METAD,MDL_WETAD,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFS1_0(W(1,6),W(1,4),W(1,7),GC_13,AMP(1))
      CALL FFS1_3(W(1,1),W(1,4),GC_13,MDL_METAD,MDL_WETAD,W(1,6))
      CALL FFV2_3_1(W(1,2),W(1,5),GC_41,GC_47,MDL_MS,ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL FFS2_0(W(1,3),W(1,4),W(1,6),GC_13,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL VSS1_0(W(1,5),W(1,6),W(1,7),GC_50,AMP(3))
