...
C     
C     Process: c c~ > z chi chi~ WEIGHTED=3
C     *   Decay: z > mu+ mu- WEIGHTED=1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV7_9_3(W(1,3),W(1,4),GC_29,GC_32,MDL_MZ,MDL_WZ,W(1,5))
      CALL OXXXXX(P(0,5),MDL_MCHI,NHEL(5),+1*IC(5),W(1,4))
      CALL IXXXXX(P(0,6),MDL_MCHI,NHEL(6),-1*IC(6),W(1,3))
      CALL FFV10_7_2(W(1,1),W(1,5),GC_31,GC_30,MDL_MC,ZERO,W(1,6))
      CALL FFV6_3(W(1,3),W(1,4),GC_12,MDL_MXI,MDL_WXI,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV6_0(W(1,6),W(1,2),W(1,7),GC_11,AMP(1))
      CALL FFV10_7_1(W(1,2),W(1,5),GC_31,GC_30,MDL_MC,ZERO,W(1,6))
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,1),W(1,6),W(1,7),GC_11,AMP(2))
