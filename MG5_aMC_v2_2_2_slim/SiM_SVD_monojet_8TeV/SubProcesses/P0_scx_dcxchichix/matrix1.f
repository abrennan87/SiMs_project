...
C     
C     Process: s c~ > d c~ chi chi~ WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV7_3(W(1,4),W(1,3),GC_53,MDL_MW,MDL_WW,W(1,7))
