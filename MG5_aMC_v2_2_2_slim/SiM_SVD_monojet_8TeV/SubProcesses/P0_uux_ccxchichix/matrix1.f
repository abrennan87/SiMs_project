...
C     
C     Process: u u~ > c c~ chi chi~ WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 18
      ...
      CALL FFS2_3(W(1,4),W(1,3),GC_42,MDL_MH,MDL_WH,W(1,9))
      CALL FFS2_2(W(1,1),W(1,9),GC_49,MDL_MU,ZERO,W(1,4))
C     Amplitude(s) for diagram number 19
      CALL FFV6_0(W(1,4),W(1,2),W(1,10),GC_16,AMP(19))
