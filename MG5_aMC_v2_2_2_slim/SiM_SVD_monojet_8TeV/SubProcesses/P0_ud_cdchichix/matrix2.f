...
C     
C     Process: u d~ > c d~ chi chi~ WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV7_2(W(1,4),W(1,7),GC_23,MDL_MC,ZERO,W(1,6))
C     Amplitude(s) for diagram number 1
      CALL FFV6_0(W(1,6),W(1,3),W(1,8),GC_11,AMP(1))
      CALL FFV7_1(W(1,3),W(1,7),GC_23,MDL_MD,ZERO,W(1,6))
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,4),W(1,6),W(1,8),GC_13,AMP(2))
      CALL FFV7_3(W(1,4),W(1,3),GC_23,MDL_MW,MDL_WW,W(1,6))
