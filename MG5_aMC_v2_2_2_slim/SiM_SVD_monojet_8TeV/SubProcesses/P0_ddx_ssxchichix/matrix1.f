...
C     
C     Process: d d~ > s s~ chi chi~ WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV6P0_3(W(1,1),W(1,2),GC_1,ZERO,ZERO,W(1,6))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFS2_3(W(1,1),W(1,2),GC_43,MDL_MH,MDL_WH,W(1,6))
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFV6P0_3(W(1,4),W(1,3),GC_1,ZERO,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 18
      ...
      CALL FFS2_3(W(1,4),W(1,3),GC_46,MDL_MH,MDL_WH,W(1,9))
      CALL FFS2_2(W(1,1),W(1,9),GC_43,MDL_MD,ZERO,W(1,4))
C     Amplitude(s) for diagram number 19
      CALL FFV6_0(W(1,4),W(1,2),W(1,10),GC_13,AMP(19))
