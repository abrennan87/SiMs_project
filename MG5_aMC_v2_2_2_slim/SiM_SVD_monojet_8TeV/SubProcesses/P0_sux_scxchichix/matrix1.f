...
C     
C     Process: s u~ > s c~ chi chi~ WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV7_2(W(1,1),W(1,7),GC_21,MDL_MU,ZERO,W(1,6))
C     Amplitude(s) for diagram number 1
      CALL FFV6_0(W(1,6),W(1,2),W(1,8),GC_16,AMP(1))
      CALL FFV7_1(W(1,2),W(1,7),GC_21,MDL_MS,ZERO,W(1,6))
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,1),W(1,6),W(1,8),GC_14,AMP(2))
      CALL FFV7_3(W(1,1),W(1,2),GC_21,MDL_MW,MDL_WW,W(1,6))
