...
C     
C     Process: s d~ > c c~ chi chi~ WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV7_3(W(1,4),W(1,2),GC_53,MDL_MW,MDL_WW,W(1,7))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV7_3(W(1,1),W(1,3),GC_24,MDL_MW,MDL_WW,W(1,6))
      CALL FFV7_2(W(1,4),W(1,6),GC_53,MDL_MD,ZERO,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL FFV6_0(W(1,3),W(1,2),W(1,8),GC_13,AMP(3))
      CALL FFV6_2(W(1,4),W(1,8),GC_11,MDL_MC,ZERO,W(1,3))
C     Amplitude(s) for diagram number 4
      CALL FFV7_0(W(1,3),W(1,2),W(1,6),GC_53,AMP(4))
