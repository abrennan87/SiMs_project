...
C     
C     Process: u u~ > s s~ chi chi~ WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFS2_3(W(1,1),W(1,2),GC_49,MDL_MH,MDL_WH,W(1,6))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV7_3(W(1,1),W(1,3),GC_51,MDL_MW,MDL_WW,W(1,9))
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFV7_3(W(1,4),W(1,2),GC_21,MDL_MW,MDL_WW,W(1,7))
...
C     Amplitude(s) for diagram number 23
      CALL FFV6_0(W(1,4),W(1,2),W(1,10),GC_16,AMP(23))
