...
C     
C     Process: u d~ > c s~ chi chi~ WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV7_3(W(1,1),W(1,2),GC_50,MDL_MW,MDL_WW,W(1,7))
      CALL FFV6_3(W(1,6),W(1,5),GC_12,MDL_MXI,MDL_WXI,W(1,8))
      CALL FFV7_2(W(1,4),W(1,7),GC_24,MDL_MC,ZERO,W(1,6))
C     Amplitude(s) for diagram number 1
      CALL FFV6_0(W(1,6),W(1,3),W(1,8),GC_11,AMP(1))
      CALL FFV7_1(W(1,3),W(1,7),GC_24,MDL_MS,ZERO,W(1,6))
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,4),W(1,6),W(1,8),GC_14,AMP(2))
      CALL FFV7_3(W(1,4),W(1,3),GC_24,MDL_MW,MDL_WW,W(1,6))
      CALL FFV7_2(W(1,1),W(1,6),GC_50,MDL_MD,ZERO,W(1,4))
C     Amplitude(s) for diagram number 3
      CALL FFV6_0(W(1,4),W(1,2),W(1,8),GC_13,AMP(3))
      CALL FFV6_2(W(1,1),W(1,8),GC_16,MDL_MU,ZERO,W(1,4))
C     Amplitude(s) for diagram number 4
      CALL FFV7_0(W(1,4),W(1,2),W(1,6),GC_50,AMP(4))
