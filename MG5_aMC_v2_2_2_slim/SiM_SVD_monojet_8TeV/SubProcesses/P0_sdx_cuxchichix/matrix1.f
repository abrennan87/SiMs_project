...
C     
C     Process: s d~ > c u~ chi chi~ WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV7_3(W(1,4),W(1,2),GC_50,MDL_MW,MDL_WW,W(1,7))
