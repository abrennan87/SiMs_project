...
C     
C     Process: c d > u d chi chi~ WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV7_3(W(1,1),W(1,4),GC_53,MDL_MW,MDL_WW,W(1,7))
