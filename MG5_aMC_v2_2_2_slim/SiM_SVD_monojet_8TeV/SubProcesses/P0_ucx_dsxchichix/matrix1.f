...
C     
C     Process: u c~ > d s~ chi chi~ WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV7_3(W(1,1),W(1,3),GC_50,MDL_MW,MDL_WW,W(1,7))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV7_3(W(1,4),W(1,2),GC_24,MDL_MW,MDL_WW,W(1,6))
...
C     Amplitude(s) for diagram number 4
      CALL FFV7_0(W(1,4),W(1,3),W(1,6),GC_50,AMP(4))
