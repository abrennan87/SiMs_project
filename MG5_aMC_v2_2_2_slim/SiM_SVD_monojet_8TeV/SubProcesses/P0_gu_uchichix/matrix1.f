...
C     
C     Process: g u > u chi chi~ WEIGHTED=3
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL OXXXXX(P(0,4),MDL_MCHI,NHEL(4),+1*IC(4),W(1,4))
      CALL IXXXXX(P(0,5),MDL_MCHI,NHEL(5),-1*IC(5),W(1,5))
      CALL FFV6_2(W(1,2),W(1,1),GC_5,MDL_MU,ZERO,W(1,6))
      CALL FFV6_3(W(1,5),W(1,4),GC_12,MDL_MXI,MDL_WXI,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV6_0(W(1,6),W(1,3),W(1,7),GC_16,AMP(1))
      CALL FFV6_1(W(1,3),W(1,1),GC_5,MDL_MU,ZERO,W(1,6))
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,2),W(1,6),W(1,7),GC_16,AMP(2))
