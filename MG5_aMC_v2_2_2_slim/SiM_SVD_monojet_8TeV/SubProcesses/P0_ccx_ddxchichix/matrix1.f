...
C     
C     Process: c c~ > d d~ chi chi~ WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV6P0_3(W(1,1),W(1,2),GC_2,ZERO,ZERO,W(1,6))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFS2_3(W(1,1),W(1,2),GC_42,MDL_MH,MDL_WH,W(1,6))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV7_3(W(1,1),W(1,3),GC_53,MDL_MW,MDL_WW,W(1,9))
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFV7_3(W(1,4),W(1,2),GC_23,MDL_MW,MDL_WW,W(1,7))
...
C     Amplitude(s) for diagram number 23
      CALL FFV6_0(W(1,4),W(1,2),W(1,10),GC_11,AMP(23))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ +AMP(23)+AMP(24)+AMP(25)+AMP(26)
      JAMP(2,1)=+1D0/2D0*AMP(3)+1D0/2D0*AMP(4)-AMP(13)-AMP(14)-AMP(15)
