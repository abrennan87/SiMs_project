...
C     
C     Process: g g > c c~ chi chi~ WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL VVV2P0_1(W(1,1),W(1,2),GC_4,ZERO,ZERO,W(1,7))
      CALL FFV6_3(W(1,6),W(1,5),GC_12,MDL_MXI,MDL_WXI,W(1,8))
      CALL FFV6_1(W(1,3),W(1,7),GC_5,MDL_MC,ZERO,W(1,6))
C     Amplitude(s) for diagram number 1
      CALL FFV6_0(W(1,4),W(1,6),W(1,8),GC_11,AMP(1))
      CALL FFV6_2(W(1,4),W(1,7),GC_5,MDL_MC,ZERO,W(1,6))
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,6),W(1,3),W(1,8),GC_11,AMP(2))
      CALL FFV6_1(W(1,3),W(1,1),GC_5,MDL_MC,ZERO,W(1,6))
      CALL FFV6_2(W(1,4),W(1,2),GC_5,MDL_MC,ZERO,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV6_0(W(1,7),W(1,6),W(1,8),GC_11,AMP(3))
      CALL FFV6_1(W(1,6),W(1,2),GC_5,MDL_MC,ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV6_0(W(1,4),W(1,5),W(1,8),GC_11,AMP(4))
      CALL FFV6_2(W(1,4),W(1,1),GC_5,MDL_MC,ZERO,W(1,5))
      CALL FFV6_1(W(1,3),W(1,2),GC_5,MDL_MC,ZERO,W(1,6))
C     Amplitude(s) for diagram number 5
      CALL FFV6_0(W(1,5),W(1,6),W(1,8),GC_11,AMP(5))
      CALL FFV6_2(W(1,5),W(1,2),GC_5,MDL_MC,ZERO,W(1,9))
C     Amplitude(s) for diagram number 6
      CALL FFV6_0(W(1,9),W(1,3),W(1,8),GC_11,AMP(6))
...
C     Amplitude(s) for diagram number 8
      CALL FFV6_0(W(1,9),W(1,3),W(1,8),GC_11,AMP(8))
