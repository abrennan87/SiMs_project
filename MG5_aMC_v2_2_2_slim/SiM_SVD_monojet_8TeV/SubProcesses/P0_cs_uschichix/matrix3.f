...
C     
C     Process: c~ s~ > u~ s~ chi chi~ WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV7_3(W(1,3),W(1,2),GC_51,MDL_MW,MDL_WW,W(1,7))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV7_2(W(1,3),W(1,6),GC_51,MDL_MS,ZERO,W(1,4))
C     Amplitude(s) for diagram number 3
      CALL FFV6_0(W(1,4),W(1,2),W(1,8),GC_14,AMP(3))
      CALL FFV6_2(W(1,3),W(1,8),GC_16,MDL_MU,ZERO,W(1,4))
