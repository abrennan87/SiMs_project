...
C     
C     Process: s s~ > c c~ chi chi~ WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV6_3(W(1,1),W(1,2),GC_14,MDL_MXI,MDL_WXI,W(1,8))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV7_3(W(1,4),W(1,2),GC_54,MDL_MW,MDL_WW,W(1,9))
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFV7_3(W(1,1),W(1,3),GC_24,MDL_MW,MDL_WW,W(1,7))
...
C     Amplitude(s) for diagram number 22
      ...
      CALL FFS2_3(W(1,1),W(1,2),GC_46,MDL_MH,MDL_WH,W(1,7))
