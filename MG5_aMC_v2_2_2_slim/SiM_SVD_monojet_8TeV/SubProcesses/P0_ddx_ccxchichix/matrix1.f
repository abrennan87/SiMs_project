...
C     
C     Process: d d~ > c c~ chi chi~ WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV6_3(W(1,4),W(1,3),GC_11,MDL_MXI,MDL_WXI,W(1,7))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFS2_3(W(1,4),W(1,3),GC_42,MDL_MH,MDL_WH,W(1,6))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV7_3(W(1,4),W(1,2),GC_53,MDL_MW,MDL_WW,W(1,9))
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFV7_3(W(1,1),W(1,3),GC_23,MDL_MW,MDL_WW,W(1,7))
...
C     Amplitude(s) for diagram number 22
      ...
      CALL FFS2_2(W(1,4),W(1,7),GC_42,MDL_MC,ZERO,W(1,2))
C     Amplitude(s) for diagram number 23
      CALL FFV6_0(W(1,2),W(1,3),W(1,10),GC_11,AMP(23))
