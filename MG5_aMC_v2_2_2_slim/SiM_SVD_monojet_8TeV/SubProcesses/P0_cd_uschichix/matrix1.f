...
C     
C     Process: c d > u s chi chi~ WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV7_3(W(1,1),W(1,4),GC_54,MDL_MW,MDL_WW,W(1,7))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV7_2(W(1,1),W(1,6),GC_54,MDL_MS,ZERO,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL FFV6_0(W(1,3),W(1,4),W(1,8),GC_14,AMP(3))
      CALL FFV6_2(W(1,1),W(1,8),GC_11,MDL_MC,ZERO,W(1,3))
C     Amplitude(s) for diagram number 4
      CALL FFV7_0(W(1,3),W(1,4),W(1,6),GC_54,AMP(4))
